...
# Parsing + Configuration Script – Proconor50 - Rev. A

This **Parsing + Configuration** script is designed for the **Proconor50** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Proconor50 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Proconor50** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
